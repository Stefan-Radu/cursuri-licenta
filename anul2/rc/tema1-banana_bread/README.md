...
# pornim receptorul
docker-compose exec receptor bash -c "python3 /elocal/src/receptor.py -p 10000 -f $fisier_de_scris"

# pornim emitatorul
docker-compose exec emitator bash -c "python3 /elocal/src/emitator.py -a $IP_receptor -p 10000 -f $fisier_de_trimis"
