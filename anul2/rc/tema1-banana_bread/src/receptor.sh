#!/bin/bash
set -x
# remove default gateway 198.8.1.1
ip route del default
# make router container the default router
ip route add default via 198.8.0.1
# add route to subnet 198.8.0.0/16 via IP 172.10.0.1
# ip route add 172.10.0.0/16 via 198.8.0.1
